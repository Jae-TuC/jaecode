import { useContext, useState, useRef, createContext, useCallback } from "react"
import { useKeyboard, useRenderer } from "@opentui/react"

type Responder = () => boolean;

type KeyboardLayerContextValue = {
    push: (id: string, responser?: Responder) => void;
    pop: (id: string) => void;
    isTopLayer: (id: string) => boolean;
    setResponder: (id: string, responser: Responder | null) => void;
}
